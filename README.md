...
This is a sample template for sam-with-npm - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-with-npm --query 'Stacks[].Outputs'
```
